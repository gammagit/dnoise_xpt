...
###               init = list(list(beta_mu=matrix(rep(c(1000,10), 16), nrow=16, ncol=2, byrow=TRUE), beta_sigma=matrix(rep(c(100,10), 16), nrow=16, ncol=2, byrow=TRUE), beta_rate=matrix(rep(c(100,10), 16), nrow=16, ncol=2, byrow=TRUE))),
              init = list(list(beta_mu=matrix(rep(c(1000,10), 18), nrow=18, ncol=2, byrow=TRUE), beta_sigma=matrix(rep(c(100,10), 18), nrow=18, ncol=2, byrow=TRUE), beta_rate=matrix(rep(c(100,10), 18), nrow=18, ncol=2, byrow=TRUE))),
              iter = 5000,
...
plot_means <- FALSE # whether to superimpose means computed using ML fit
if (plot_means) {
